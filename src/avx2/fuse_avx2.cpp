...
template b_t<float, xsimd::avx2> EASY_JIT_EXPOSE batch_normal(b_t<float, xsimd::avx2> x, const CallerContext context, const FuseMutableAlgParam param_m, const FuseConstAlgParam param_c);
